    ...
    _create_class(Config, [
        {
            ...
            value: function init(config) {
                var _config_groupSubscriptionsLimit, _config_groupSubscriptionsLimit1;
                var maxSubscriptionsToShow = (_config_groupSubscriptionsLimit = config.groupSubscriptionsLimit) === null || _config_groupSubscriptionsLimit === void 0 ? void 0 : _config_groupSubscriptionsLimit.maxSubscriptionsToShow;
                var periodInDays = (_config_groupSubscriptionsLimit1 = config.groupSubscriptionsLimit) === null || _config_groupSubscriptionsLimit1 === void 0 ? void 0 : _config_groupSubscriptionsLimit1.periodInDays;
                this.set(config);
                this.sakSessionStatsCollector.sendSdkInit(config.source, [
                    {
                        name: "limit_settings",
                        value: "".concat(maxSubscriptionsToShow ? maxSubscriptionsToShow : 2, ";").concat(periodInDays ? periodInDays : 30)
                    }
                ]);
