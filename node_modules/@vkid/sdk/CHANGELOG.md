...
#### Changed
+ Добавлена возможность выставления версии OAuth через конфиг SDK
### 2.6.5

#### Changed
+ Сделал несколько важных правок
+ Обновлена библиотека crypto-js до 4.2.0
### 2.6.4

#### Changed
+ Сделал несколько важных правок (VKIDEXP-5603)
### 2.6.3

#### Changed
+ Обновлена библиотека crypto-js до 4.2.0 (VKIDEXP-5176)
### 2.6.2 (15-10-2025)

#### Changed
+ Добавлен тестовый комментарий, что бы проверить работоспособность джоб (VKIDEXP-4978)
### 2.6.1 (10-09-2025)
