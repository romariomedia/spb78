...
export interface UserProfile {
  ...
  likedUserIds: string[];
  matchIds: string[];
  /** Mutual matches created in the last 7 days; used for the free-plan limit. */
  matchHistory?: Array<{ userId: string; at: number }>;
  ...
  medalProgress?: import('./medals').MedalProgress; // server-authoritative medal state; localStorage is cache only
  welcomeTrialGrantedAt?: string;
